"""
Teste de download individual - Relatório de Status de Atividades

Uso:
    python tests/test_download_status.py [--headless] [--timeout 60]
...
def test_download_status_atividades(headless=False, timeout=60):
    """
    Testa download individual do relatório de Status de Atividades.
    ...
    try:
        ...
        logger.info("=" * 70)
        logger.info("🧪 TESTE: Download Individual - Status de Atividades")
        logger.info("=" * 70)
        ...
        # Download
        logger.info("[5/5] Iniciando download de Status...")
        exportAtividadesStatus(driver)
        time.sleep(2)
        
        logger.info("=" * 70)
        logger.info("✅ SUCESSO: Download de Status concluído!")
        logger.info("=" * 70)
...
def main():
    parser = argparse.ArgumentParser(
        description="Download individual: Relatório de Status de Atividades",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Exemplos de uso:
  python tests/test_download_status.py              # Download com UI visível
  python tests/test_download_status.py --headless   # Modo headless (sem UI)
  python tests/test_download_status.py --timeout 120 # Timeout de 120s
        """
    )
    ...
    # Executar teste
    success = test_download_status_atividades(
